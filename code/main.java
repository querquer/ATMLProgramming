...
public class main {
	...
	protected static void classify(Instances data) throws Exception {
		...
		// Naive Bayes
		// NaiveBayes classifierNaiveBayes = new NaiveBayes(); // init
		// classifier
		...
		// classifier
		// System.out.println(evalNaiveBayes.toSummaryString()); // print
		// summary
		// System.out.println(evalNaiveBayes.toMatrixString()); // print
		// confusion matrix
		...
		// System.out.println(evalIb1.toMatrixString()); // print confusion
		// matrix

		// SVM
		LibSVM classifierSVM = new LibSVM(); // init classifier
		classifierSVM.buildClassifier(training); // build classifier
		SelectedTag tag2 = new SelectedTag(LibSVM.KERNELTYPE_POLYNOMIAL,
				LibSVM.TAGS_KERNELTYPE);
		SelectedTag tag = new SelectedTag(LibSVM.SVMTYPE_C_SVC,
				LibSVM.TAGS_SVMTYPE);
