...
public class main {
	...
	*/
	protected static void classify(Instances data) throws Exception {
	    ...
	    classifierIb1.buildClassifier(train); // build classifier
...
//	    System.out.println("-----------     Cross Validation     -----------");
//	    Evaluation evalCrossIb1 = new Evaluation(data); // init evaluation
//	    evalCrossIb1.crossValidateModel(classifierIb1, data, folds, seed); // evaluate classifier
//	    System.out.println(evalCrossIb1.toSummaryString()); // print summary
//	    System.out.println(evalCrossIb1.toMatrixString()); // print confusion matrix
	    ...
	    DecisionTable classifierDecisionTable = new DecisionTable(); // init classifier
	    ...
	    evalCrossDecisionTable.crossValidateModel(classifierDecisionTable, data, folds, seed); // evaluate classifier
	...
	*/
	protected static Instances preprocessing(Instances data) throws Exception {
		...
		remove.setAttributeIndicesArray(new int[] { 0, 1, 5, 10, 25, 26, 27,
				32, 35, 36, 37, 38, 39, 40, 42, 43, 44, 45, 46 });
